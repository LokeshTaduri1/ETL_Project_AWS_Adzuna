...
ADZUNA_APP_ID = 'ADZUNA_APP_ID' # Fill with your adzuna app id
ADZUNA_APP_KEY = 'ADZUNA_APP_KEY' # Fill with your adzuna app key
...
for job in all_job_postings:
    parsed_jobs.append(
        dict(
            ...
            job_company = job.get('company', {}).get('display_name', 'Unknown'),
            job_category = job.get('category', {}).get('label', 'Unknown'),
